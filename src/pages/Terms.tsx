  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-3xl">
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <p>
          Welcome to Mo Saints. These terms govern your use of our website and services. 
        ...
        <p>
          The Mo Saints brand, product descriptions, and website design are our exclusive 
          property. All content, images, and branding are original creations.
        </p>
        <h2 className="font-serif text-xl text-foreground pt-2">Product Information</h2>
        <p>
          Mo Saints does not make any health or medical claims about its products. 
        ...
        <p>
          ...
          Mo Saints is not liable for any damages arising from the use of this website.
        </p>
      </div>
    </div>
  );
